...
*关于其他用法，请见 [osu! (消歧义)](/wiki/Disambiguation/osu!).*

![osu! 玩法](/wiki/shared/osu-gameplay.jpg "osu! Interface")

osu!模式是本游戏最先拥有的游戏模式，它的名称来源于《应援团》系列游戏。

## 什么是“应援团”

《*[押忍！战斗！应援团](https://zh.wikipedia.org/wiki/%E6%8A%BC%E5%BF%8D%EF%BC%81%E6%88%B0%E9%AC%A5%EF%BC%81%E6%87%89%E6%8F%B4%E5%9C%98)*》 是一款 *Nintendo DS* 上的音乐节奏游戏。 它的可玩部分包含三种部件：在触摸屏上点击圆圈、拖动一个圆球经过指定的路线、快速转动一个转盘。这些部件与歌曲的节奏一一对应，而歌曲则为流行的日文歌曲（或其翻唱）。在 *DS* 上的游玩体验如下：

![Nintendo DS 上《押忍！战斗！应援团》的游玩示例](/wiki/shared/Ouendan.jpg "Gameplay example of Osu! Tatakae! Ouendan in Nintendo DS")

游戏的互动要素位于下屏，而故事则展示在上屏。每一关基本上都以单元剧形式，讲述*应援团*（日本的一种啦啦队）帮助遇到麻烦的人的故事。虽然应援团的小伙子们都掌握着神奇的力量，玩家仍然需要协助他们完成助人为乐的任务。

## ![](/wiki/shared/mode/osu.png) 玩法

*教程: [new beginnings (osu! 自带)](https://osu.ppy.sh/beatmapsets/1011011).*
*中文版可从这里下载： [new beginnings (简体中文)](https://osu.ppy.sh/beatmapsets/1326256)*

玩法的重点：

- 对外界信号的适应性和反应速度（外界信号，指在屏幕各个位置极快闪出的各种击打部件）
- 理解歌曲的节拍与编排
- 对输入设备的掌控
- 掌握击打屏幕上物件的时机
- 在转盘上旋转鼠标（或数位笔）的能力
- 身体耐力以及心理上的韧性（尤其是面对较长的马拉松类歌曲）
- 精确定位能力以及手眼协调
